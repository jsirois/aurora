...
public final class Query {
  ...
  public static final class Builder implements Supplier<TaskQuery> {
    ...
    static TaskQuery.Builder sanitizeOwner(TaskQuery query) {
      // TODO(maxim): Safe to keep only Role here as TaskQuery is not returned back to the client.
      // Remove in 0.7.0. (AURORA-749)
      TaskQuery.Builder builder = query.toBuilder();
      if (query.isSetOwner()) {
        builder.setRole(query.getOwner().getRole());
        builder.setOwner(null);
      }
      return builder;
    }

    private final TaskQuery.Builder query;

    Builder() {
      this(TaskQuery.builder());
    }

    Builder(TaskQuery query) {
      this(sanitizeOwner(query));
    }

    Builder(TaskQuery.Builder query) {
      this.query = query;
    }
    ...
    public boolean equals(Object that) {
      return that != null
          ...
          && Objects.equals(get(), ((Builder) that).get());
    }
    ...
    private TaskQuery.Builder deepCopy() {
    ...
    public Builder byId(Iterable<String> taskIds) {
      ...
      return new Builder(deepCopy().setTaskIds(taskIds));
    }
    ...
    public Builder byRole(String role) {
      ...
      return new Builder(deepCopy().setRole(role));
    }
    ...
    public Builder byEnv(String role, String environment) {
      ...
      return new Builder(deepCopy().setRole(role).setEnvironment(environment));
    }
    ...
    public Builder byJob(JobKey jobKey) {
      ...
      return new Builder(deepCopy().setJobKeys(ImmutableSet.of(jobKey)));
    }
    ...
    public Builder bySlave(Iterable<String> slaveHosts) {
      ...
      return new Builder(deepCopy().setSlaveHosts(ImmutableSet.copyOf(slaveHosts)));
    }
    ...
    public Builder byStatus(ScheduleStatus status, ScheduleStatus... statuses) {
      ...
      return new Builder(deepCopy().setStatuses(EnumSet.of(status, statuses)));
    }
    ...
    public Builder byStatus(Iterable<ScheduleStatus> statuses) {
      ...
      return new Builder(
          deepCopy().setStatuses(EnumSet.copyOf(ImmutableSet.copyOf(statuses))));
    }
    ...
    public Builder byJobKeys(Iterable<JobKey> jobKeys) {
      ...
      return new Builder(deepCopy().setJobKeys(jobKeys));
    }
