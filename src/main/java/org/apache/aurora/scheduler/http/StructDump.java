...
public class StructDump extends JerseyTemplateServlet {
  ...
  public Response dumpJob(
    ...
    return dumpEntity("Task " + taskId, new Work.Quiet<Optional<? extends ThriftStruct<?>>>() {
      @Override
      public Optional<? extends ThriftStruct<?>> apply(StoreProvider storeProvider) {
  ...
  public Response dump(
    ...
    return dumpEntity("Cron job " + JobKeys.canonicalString(jobKey),
        new Work.Quiet<Optional<? extends ThriftStruct<?>>>() {
          @Override
  ...
  private Response dumpEntity(
      final String id,
      final Quiet<Optional<? extends ThriftStruct<?>>> work) {

    return fillTemplate(new Closure<StringTemplate>() {
      @Override
      public void execute(StringTemplate template) {
        template.setAttribute("id", id);
        Optional<? extends ThriftStruct<?>> struct = storage.read(work);
        if (struct.isPresent()) {
