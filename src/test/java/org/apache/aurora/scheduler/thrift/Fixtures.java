...
final class Fixtures {
  ...
  static final Lock LOCK = Lock.builder().setKey(LOCK_KEY).setToken("token").build();
  static final JobConfiguration CRON_JOB = makeJob().withCronSchedule("* * * * *");
  static final String TASK_ID = "task_id";
  static final String UPDATE_ID = "82d6d790-3212-11e3-aa6e-0800200c9a74";
  static final JobUpdateKey UPDATE_KEY = JobUpdateKey.create(JOB_KEY, UPDATE_ID);
  static final UUID UU_ID = UUID.fromString(UPDATE_ID);
  static final String CRON_SCHEDULE = "0 * * * *";
  static final ResourceAggregate QUOTA = ResourceAggregate.create(10.0, 1024, 2048);
